  ...
  return (
    <div
      className={`fixed top-0 left-0 w-screen h-screen flex items-center
          justify-center bg-black bg-opacity-50 transform z-[150]
          transition-transform duration-300 ${showModal}`}
    >
      <div className="bg-[#ffffff] shadow-sm rounded-xl w-11/12 md:w-2/5 h-7/12 p-6">
        <div className="flex flex-col">
          <div className="flex flex-row justify-between items-center">
            <p className="font-semibold text-black-400 text-xl">Buy NFT</p>
            <button
              type="button"
          ...
          <div className="flex flex-col justify-start rounded-xl mt-5">
            <h4 className="text-black text font-semibold">{nft?.title}</h4>
            <p className="text-black-400 text my-1">{nft?.description}</p>
